...
test("SearchImagesCreative: withCollectionCode will include collection_codes in query", t => {  
    var client = new api({ apiKey: "apikey", apiSecret: "apisecret" }, null);
...
test("SearchImagesCreative: withEmbedContentOnly will include embed_content_only in query", t => {  
    var client = new api({ apiKey: "apikey", apiSecret: "apisecret" }, null);
    return Promise.resolve(client.searchimagescreative().withPhrase("cat").withEmbedContentOnly(true).execute()).then(res => {
...
test("SearchImagesCreative: withExcludeNudity will include exclude_nudity in query", t => {  
    var client = new api({ apiKey: "apikey", apiSecret: "apisecret" }, null);
    return Promise.resolve(client.searchimagescreative().withPhrase("cat").withExcludeNudity(true).execute()).then(res => {
...
test("SearchImagesCreative: withPrestigeContentOnly will include prestige_content_only in query", t => {  
    var client = new api({ apiKey: "apikey", apiSecret: "apisecret" }, null);
    return Promise.resolve(client.searchimagescreative().withPhrase("cat").withPrestigeContentOnly(true).execute()).then(res => {
