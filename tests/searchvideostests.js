...
test("SearchVideos: withCollectionCode will include collection_codes in query", t => {  
    var client = new api({ apiKey: "apikey", apiSecret: "apisecret" }, null);
...
test("SearchVideos: withEditorialVideoType will include editorial_video_types in query", t => {  
    var client = new api({ apiKey: "apikey", apiSecret: "apisecret" }, null);
...
test("SearchVideos: withExcludeNudity will include exclude_nudity in query", t => {  
    var client = new api({ apiKey: "apikey", apiSecret: "apisecret" }, null);
    return Promise.resolve(client.searchvideos().withPhrase("cat").withExcludeNudity(true).execute()).then(res => {
