...
test("SearchVideosCreative: withCollectionCode will include collection_codes in query", t => {  
    var client = new api({ apiKey: "apikey", apiSecret: "apisecret" }, null);
...
test("SearchVideosCreative: withExcludeNudity will include exclude_nudity in query", t => {  
    var client = new api({ apiKey: "apikey", apiSecret: "apisecret" }, null);
    return Promise.resolve(client.searchvideoscreative().withPhrase("cat").withExcludeNudity(true).execute()).then(res => {
...
test ("SearchVideosCreative: withAcceptLanguage will include the Accept-Language header in request", t=> {
    var client = new api({apiKey: "apikey", apiSecret: "apisecret" }, null);
